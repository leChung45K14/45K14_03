<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="course-detail-n5.aspx.cs" Inherits="OnlineEdu.Front_End.course_detail_n5" %>
                        ...
                        <div class="course-details__content">
                            ...
                            <div class="course-details__top">
                                <div class="course-details__top-left">
                                    <h2 class="course-details__title">JLPT N5</h2>
                            ...
                            <div class="tab-content course-details__tab-content ">
                                <div class="tab-pane show active  animated fadeInUp" role="tabpanel" id="overview">
                                    <p class="course-details__tab-text">The “Online Japanese N5 Course” is Japanese study materials related to the JLPT N5 level. You can study vocabulary, expressions, and grammar that correspond to the JLPT N5 level. 
                                    ...
                                    <br>
                                    <p class="course-details__tab-text">It is suitable for beginners. You can learn and practice all four skills of the Japanese language — speaking, listening, reading, and writing.
                                    ...
                                    <ul class="list-unstyled course-details__overview-list">
                                        <li>Master the basics of writing and pronunciation of Japanese vocabulary.</li>
                                        <li>Being able to use basic greetings often used in daily life.</li>
                                        <li>Being able to have short simple conversations in daily life, and understand.</li>
                                        <li>Master vocabulary, expressions, and grammar related to the JLPT N5 level.</li>
                                    ...
                                    <div class="course-details__comment">
                                        <div class="course-details__comment-single">
                                            <div class="course-details__comment-top">
                                                ...
                                                <div class="course-details__comment-right">Nhat Lam</h2>
                                        ...
                                        <div class="course-details__comment-single">
                                            ...
                                            <p class="course-details__comment-text">Amazing! Tons of information. All lessons were conducted well.
                        ...
                        <div class="course-details__list">
                            ...
                            <div class="course-details__list-item">
                                ...
                                <div class="course-details__list-content">
                                    ...
                                    <h3><a href="course-details-n4.html">JLPT N4</a></h3>
