...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./Register/bootstrap.min.css">
    <link type="text/css" rel="stylesheet" href="./Register/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="./Register/flaticon.css">
    ...
    <link href="./Register/css2" rel="stylesheet">

    <!-- Custom Stylesheet -->
    <link type="text/css" rel="stylesheet" href="./Register/style.css">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="./Register/default.css">
...
<body id="top" data-new-gr-c-s-check-loaded="14.1052.0" data-gr-ext-installed="">
                        ...
                        <div class="form-section clearfix">
                            ...
                            <form
                                ...
                                <div class="form-group clearfix">
                                    <div class="form-box">
                                        <input name="name" type="text" class="form-control" id="third_field"
                                ...
                                <div class="form-group clearfix">
                                    <button type="submit"
                                        class="btn btn-primary btn-lg btn-theme w-100">Register</button>
                                </div>
                            </form>
    ...
    <script src="./Register/jquery.min.js.tải xuống"></script>
