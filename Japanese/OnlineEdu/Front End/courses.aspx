                    ...
                    <div class="col-lg-4">
                        <div class="course-one__single">
                            ...
                            <div class="course-one__content">
                                ...
                                <a href="course-details-n4.html" class="course-one__link">See Preview</a><!-- /.course-one__link -->
                            </div><!-- /.course-one__content -->
                        </div><!-- /.course-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <div class="course-one__single">
                            ...
                            <div class="course-one__content">
                                ...
                                <a href="course-details-n3.html" class="course-one__link">See Preview</a><!-- /.course-one__link -->
                            </div><!-- /.course-one__content -->
                        </div><!-- /.course-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <div class="course-one__single">
                            ...
                            <div class="course-one__content">
                                ...
                                <a href="course-details-n2.html" class="course-one__link">See Preview</a><!-- /.course-one__link -->
                            </div><!-- /.course-one__content -->
                        </div><!-- /.course-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <div class="course-one__single">
                            ...
                            <div class="course-one__content">
                                ...
                                <a href="course-details-n1.html" class="course-one__link">See Preview</a><!-- /.course-one__link -->
                            </div><!-- /.course-one__content -->
                        </div><!-- /.course-one__single -->
                    </div><!-- /.col-lg-4 -->
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12">
                            <div class="footer-widget footer-widget__contact">
                                ...
                                <ul class="list-unstyled footer-widget__course-list">
                                    ...
                                    <li>
                                        <h2><a href="course-details-n3.html"> Online Japanese for intermediate students </a></h2>
                                        <p>Thuy Chill</p>
                                    </li>
